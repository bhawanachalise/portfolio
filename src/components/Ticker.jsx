...
const ITEMS=['App Design','Web Design',,'Logo Design',,'Social Media Post','Product Design','Branding','App Design',,'Web Design','Logo Design','Social Media Post','Product Design','Branding','App Design','Web Design',,'Logo Design',,'Social Media Post','Product Design','Branding',];
